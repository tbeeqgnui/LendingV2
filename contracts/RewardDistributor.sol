...
contract RewardDistributor is Initializable, Ownable, IRewardDistributor {
    ...
    Controller public override controller;
     ...
     */
    function isRewardDistributor() external view override returns (bool) {
        return true;
    }
    ...
    function _updateDistributionSpeed() internal {
        ...
        for (uint256 i = 0; i < _len; i++) {
            ...
            uint256 _underlyingPrice = IPriceOracle(controller.priceOracle())
        ...
        for (uint256 i = 0; i < _len; i++) {
            ...
            uint256 _borrowSpeed = _totalBorrowValue > 0
            ...
            uint256 _supplySpeed = _totalSupplyValue > 0
    ...
    function _setDistributionFactor(
        ...
        uint256 _oldDistributionFactorMantissa = distributionFactorMantissa[
            _iToken
        ];
