...
contract InterestRateModelV2 {
    ...
    constructor(
        ...
        require(
            _optimal < ONE,
            "interestRateModelV2: Optimal should be less than 1!"
        );
        require(
            _slope_1 <= ONE,
            "interestRateModelV2: Slope 1 can not exceed 1!"
        );
        require(
            _blocksPerYear > 0,
            "interestRateModelV2: Blocks per year can not be zero!"
        );
        base = _base;
        optimal = _optimal;
        slope_1 = _slope_1;
...
contract StablePrimaryInterestModel is InterestRateModelV2 {
    constructor(
        uint256 _blocksPerYear
    ) public InterestRateModelV2(0, 0.9e18, 0.05e18, 0.6e18, _blocksPerYear) {}
}

contract StableSecondaryInterestModel is InterestRateModelV2 {
    constructor(
        uint256 _blocksPerYear
    ) public InterestRateModelV2(0, 0.8e18, 0.07e18, 1e18, _blocksPerYear) {}
}

contract BNBLikeInterestModel is InterestRateModelV2 {
    constructor(
        uint256 _blocksPerYear
    ) public InterestRateModelV2(0, 0.9e18, 0.09e18, 1e18, _blocksPerYear) {}
}

contract MainPrimaryInterestModel is InterestRateModelV2 {
    constructor(
        uint256 _blocksPerYear
    ) public InterestRateModelV2(0, 0.7e18, 0.05e18, 1e18, _blocksPerYear) {}
}

contract MainSecondaryInterestModel is InterestRateModelV2 {
    constructor(
        uint256 _blocksPerYear
    ) public InterestRateModelV2(0, 0.65e18, 0.07e18, 0.8e18, _blocksPerYear) {}
}

contract CakeLikeInterestModel is InterestRateModelV2 {
    constructor(
        uint256 _blocksPerYear
    ) public InterestRateModelV2(0, 0.65e18, 0.07e18, 1.2e18, _blocksPerYear) {}
}

contract ETHLikeInterestModel is InterestRateModelV2 {
    constructor(
        uint256 _blocksPerYear
    ) public InterestRateModelV2(0, 0.7e18, 0.03e18, 0.25e18, _blocksPerYear) {}
}
