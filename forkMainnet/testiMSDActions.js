...
describe("Simulate all actions in iMSD contract of general pool", function () {
  ...
  it("Borrow and repay MSD token", async function () {
    ...
    for (let i = 0; i < alliMTokensLength; i++) {
      ...
      console.log(
        "Before borrowing MSD, user balance is: ",
        beforeUserMSDBalance.toString()
      );
  ...
  it("Repay borrow for others", async function () {
    ...
    for (let i = 0; i < alliMTokensLength; i++) {
      ...
      let afterRepayBorrowUserMSDBalance = await iMToken.borrowBalanceStored(
        mocker
      );
      console.log(
        "After repaying MSD, user balance is:   ",
  ...
  it("Liquidate borrow", async function () {
    ...
    for (let i = 0; i < alliMTokensLength; i++) {
      ...
      let beforeUserMSDBorrowedBalance = await iMToken.borrowBalanceStored(
        mocker
      );
      console.log(
      ...
      let afterUserMSDBorrowedBalance = await iMToken.borrowBalanceStored(
        mocker
      );
      console.log(
