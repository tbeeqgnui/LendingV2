...
async function main() {
  ...
  let rewardDistributionFactory = await ethers.getContractFactory(
    "RewardDistributor"
  );
  let rewardDistributor = rewardDistributionFactory.attach(
    rewardDistributorAddress
  );
  console.log(
    "rewardDistributor address is: ",
  ...
  console.log(
    "\nreward token in distributor contract is: ",
    currentRewardToken
  );
  currentGlobalDistributionSpeed = await rewardDistributor.globalDistributionSpeed();
  console.log(
    "\ndistribute speed in distributor contract is: ",
    await formatToHumanReadable(currentGlobalDistributionSpeed)
  );
}
